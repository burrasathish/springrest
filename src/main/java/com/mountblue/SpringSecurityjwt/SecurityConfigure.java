...
import com.mountblue.SpringSecurityjwt.filters.JwtRequestFilter;
...
//securityconfigure call the configure
    @Autowired
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(myUserDetailService); //call the mysuserdetail service
    }
